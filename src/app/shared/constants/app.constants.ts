export const AppConstants = {
    ...
    SessionOption:{
        ROWS_PRINCIPAL:'ROWS_PRINCIPAL',
        PROVEEDOR_PLANE:'PROVEEDOR_PLANE',
        LABORATORIO_PLANE:'LABORATORIO_PLANE',
        ULTIMAS_COMPRAS: 'ULTIMAS_COMPRAS',
        ULTIMOS_INGRESOS: 'ULTIMOS_INGRESOS',
        COSCOM:'COSCOM',
        CALCULOS_TOTALES: 'CALCULOS_TOTALES',

        ROWS_PRINCIPAL_ABADI:'ROWS_PRINCIPAL_ABADI',
        PROVEEDOR_ABADI:'PROVEEDOR_ABADI',
        LABORATORIO_ABADI:'LABORATORIO_ABADI',
        COMPRAS_ABADI: 'COMPRAS_ABADI',
        INGRESOS_ABADI: 'INGRESOS_ABADI',
        BOTICAS_ABADI: 'BOTICAS_ABADI'
    }
